...
export class ThirdLayoutComponent implements AfterViewInit {
  ...
  projects = [
    {  image: 'assets/social_media.jpg',  title: 'Social Media Platform',  description: 'Developed a complete social media platform from scratch. Built the backend using Python and PostgreSQL to handle authentication, posts, comments, and user profiles. Created the frontend using Vue.js and TypeScript, focusing on an interactive user experience with real-time updates and clean UI components.',  type: 'web app',  languages: ['javascript', 'react', 'node.js'],  platforms: ['web'],  url: 'https://github.com/Mayoengin/social-media-platform'},
    { image: 'assets/gameover.jpg', title: 'Text Adventure Game', description: '', type: 'game', languages: ['java'], platforms: ['eclipse'], url: 'https://github.com/Mayoengin/text_adventure_game' },
  ...
  updateActivePoint(container: HTMLElement): void {
    ...
    const totalIndicators = 3; // Assuming 3 indicators
